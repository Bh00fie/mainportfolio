...
import './style.css';
import italyOrigin from '../Images/italy.jpg'
import cumminsPhoto from '../Images/cummins.JPG'
import codingPhoto from '../Images/programming.png'
    ...
    return (
        <div id='aboutmePage'>
            ...
            <div className = 'aboutmeParagraph' id='aboutmeSecondParagraph'>
                ...
                <div className='aboutmePhotoMain'>
                    <img className = 'aboutmePhoto' id='aboutmeSecondPhoto' src = {cumminsPhoto} alt='cummins'/>
                </div>
            </div>
            <div className = 'aboutmeParagraph' id='aboutmeThirdParagraph' >
                <div className='aboutmePhotoMain'>
                    <img className = 'aboutmePhoto' id='aboutmeThirdPhoto' src = {codingPhoto} alt='react'/>
                </div>
