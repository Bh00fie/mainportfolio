    ...
    return (
        <div id='aboutmePage'>
            ...
            <div className = 'aboutmeParagraph' id='aboutmeFirstParagraph' >
                <img className = 'aboutmePhoto' id='aboutmeFirstPhoto' src = 'https://placehold.co/600x400' alt='photoofPlace'/>
            ...
            <div className = 'aboutmeParagraph' id='aboutmeSecondParagraph'>
                <img className = 'aboutmePhoto' id='aboutmeSecondPhoto' src = 'https://placehold.co/600x400' alt='photoofPlace'/>
            ...
            <div className = 'aboutmeParagraph' id='aboutmeThirdParagraph' >
                <img className = 'aboutmePhoto' id='aboutmeThirdPhoto' src = 'https://placehold.co/600x400' alt='photoofPlace'/>
